...
(() => {
  ...
  createLevel(LevelRegistry.register({
    ...
    brief: 'Питание есть, лампа целая, а света нет. Между питанием и лампой оставлено пустое гнездо — пока в нём ничего нет, кольца нет тоже. Положи в гнездо перемычку и посмотри, что изменится на приборах.',
    lesson: 'Ток не «выходит» из источника и не «приходит» в лампу — он идёт по кольцу целиком: от плюса через всё, что стоит на пути, и обратно в минус. Разрыв в ЛЮБОМ месте кольца останавливает ток ВЕЗДЕ, а не только там, где разрыв. Пустое гнездо — это и есть разрыв.',
    ...
    goalText: 'Замкни кольцо — лампа должна загореться.',
