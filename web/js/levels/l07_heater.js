...
const Level07 = createLevel(LevelRegistry.register({
  ...
  brief: 'Обогреву стекла нужен резистор на 75 ом, а в ящике такого нет.',
  lesson: 'Два резистора рядом пропускают больше тока, чем один: у тока два пути. И греется каждый вдвое меньше.',
  hints: [
