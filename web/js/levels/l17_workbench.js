...
const Level17 = createLevel(LevelRegistry.register({
  ...
  brief: 'Пустое место и ящик деталей. Собери сигнальный светодиод — тот же, что в первом задании, но без готовой платы: расставь и соедини всё сам.',
  lesson: 'Ничего нового по электричеству здесь нет — и в этом смысл. Резистор ограничивает ток так же, как всегда; провод соединяет две точки в одну; закон Ома работает одинаково что на готовой плате, что на пустом месте. Если предыдущие шестнадцать приборов понятны, этот верстак — просто применение того же самого без подсказки в виде уже нарисованной схемы.',
  hints: [
    ...
    'Ток нужен 15–26 мА. На светодиоде падает около 1,8 В, у батареи девять — на резисторе останется примерно 7,2 В. Раздели на 0,02 А.',
  ],
