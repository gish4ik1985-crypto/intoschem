...
const Level03 = createLevel(LevelRegistry.register({
  ...
  brief: 'Подсветка слепит. Подбери резистор, чтобы лампа светила вполсилы.',
  lesson: 'Резистор и лампа делят напряжение батареи между собой. Чем больше резистор, тем меньше достаётся лампе.',
  hints: [
    ...
    'Слишком ярко — бери резистор побольше, слишком тускло — поменьше.',
  ],
