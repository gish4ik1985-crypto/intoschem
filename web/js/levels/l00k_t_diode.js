...
(() => {
  ...
  createLevel(LevelRegistry.register({
    ...
    brief: 'Диод пропускает ток только в одну сторону. Поставь его так, чтобы лампа загорелась.',
    lesson: 'Диод — дверь, которая открывается только в одну сторону. Полоска на корпусе — выход. Поставишь наоборот — ток не пройдёт.',
