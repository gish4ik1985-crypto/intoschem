...
(() => {
  ...
  createLevel(LevelRegistry.register({
    ...
    brief: 'Осветитель должен давать паспортные 250 мА — не больше, иначе он слепит приёмник, и не меньше, иначе тот ничего не увидит. Вместо гнезда здесь подстроечное сопротивление: его крутят, а не меняют.',
    lesson: 'Подстроечное сопротивление — тот же резистор, только его номинал двигают рукой, не вынимая из платы. Полезно там, где нужное значение заранее неизвестно или должно подбираться на месте: ток в ветке по-прежнему считается по закону Ома, просто одно из слагаемых теперь непрерывно.',
    ...
    hints: [
      ...
      'Лампа сама даёт 30 Ом. Двенадцать вольт делить на 0,25 ампера — это 48 Ом на всю ветку.',
    ],
    ...
    goalText: 'Ток осветителя — 250 мА (допуск ±6%).',
