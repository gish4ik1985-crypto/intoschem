...
const Level04 = createLevel(LevelRegistry.register({
  ...
  brief: 'Пять ламп, одна перегорела — и погасли все. Запасной лампы нет, и дело вообще не в ней: гирлянда перепаяна в одну цепочку.',
  lesson: 'В цепочке ток один на всех: обрыв в одной лампе останавливает его во всей гирлянде, а напряжение делится между всеми, и никто не горит в полную силу. На общей шине каждая лампа получает все двенадцать вольт и живёт своей жизнью — перегоревшая гаснет одна.',
  hints: [
    ...
    'Каждая лампа рассчитана на полные двенадцать вольт. Значит, каждой нужны свои двенадцать, а не пятая часть.',
  ],
  ...
  goalText: 'Четыре целые лампы должны гореть в полную силу.',
