...
const Level08 = createLevel(LevelRegistry.register({
  ...
  brief: 'Мотор стоит, хотя батарейки свежие. Посмотри, как они вставлены.',
  lesson: 'Батарейки складываются, только если смотрят в одну сторону. Перевёрнутая отнимает. Диод не пускает ток назад и бережёт мотор.',
  hints: [
  ...
  goalText: 'Мотор крутится в полную силу.',
