...
const Level11 = createLevel(LevelRegistry.register({
  ...
  brief: 'Кнопка нажимается, а насос молчит. Реле щёлкать перестало после того, как в цепь его катушки кто-то добавил деталь «чтобы не сгорела».',
  lesson: 'Реле срабатывает не от напряжения, а от тока через катушку: не хватило нескольких миллиампер — якорь не притянулся, и всё. Зато его контакт коммутирует ток в двадцать раз больший, и цепь управления с силовой цепью при этом вообще не соединены.',
  hints: [
  ...
  goalText: 'Насос должен работать, пока держишь кнопку, при токе управления не больше 20 мА.',
