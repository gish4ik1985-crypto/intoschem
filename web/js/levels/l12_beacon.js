...
const Level12 = createLevel(LevelRegistry.register({
  ...
  brief: 'Маячок мигает так часто, что сливается. Сделай мигание медленнее.',
  lesson: 'Конденсатор заполняется через резистор, как ведро через кран. Больше резистор или ёмкость — дольше пауза между вспышками.',
  hints: [
  ...
  goalText: 'Маячок мигает раз в полторы-две секунды.',
