...
const Level02 = createLevel(LevelRegistry.register({
  ...
  brief: 'Лампа не горит. Питание есть, лампа целая — но между ними цепь где-то не сходится.',
  lesson: 'Ток идёт только по кругу: от плюса источника через все детали и обратно к минусу. Разрыв в любом месте круга останавливает ток везде — не «до места разрыва», а во всей цепи сразу.',
  hints: [
  ...
  goalText: 'Лампа должна гореть в полную силу и продолжать гореть.',
